  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-8 flex flex-col justify-between font-sans">
      <nav className="border-b border-slate-900 pb-4 flex justify-between items-center">
        <span className="text-xl font-black tracking-wider text-lime-400">ABSOLUTE_AURA</span>
        <span className="text-xs bg-lime-950 text-lime-400 px-3 py-1 rounded border border-lime-900">Cloud Active</span>
      </nav>
